    ...
    <div class="page">
        <div class="header">
            ...
            <div class="top-right-info">
                <div class="control-number">102424</div>
                <div class="date-line">
                    <span>Date:</span>
                    <span class="date-val">
                        November 24, 2025
        ...
        <div class="auth-block">
            <span>of.</span>
            <span class="auth-line" style="width: 200px;">SSI METAL CORP.</span>
        ...
        <table class="item-table">
            ...
            <tbody>
                <tr>
                    <td>1 &nbsp;&nbsp; *unit</td>
                    <td>*Rotary Hammer Drill sn:00693</td>
                    <td></td>
                </tr>
                <tr>
                    <td>1 &nbsp;&nbsp; *unit</td>
                    <td>*Disc Grinder AEG sn: 60922</td>
                    <td></td>
                </tr>
                <tr>
                    <td>1 &nbsp;&nbsp; *pc</td>
                ...
                <tr>
                    <td>2 &nbsp;&nbsp; *length</td>
                    <td>*Extension Wire 50meters each</td>
                    <td></td>
                </tr>
                <tr>
                    <td>1 &nbsp;&nbsp; *unit</td>
                    <td>*Welding Machine POWER CRAFT sn: 0002</td>
                    <td></td>
                </tr>
                <tr>
                    <td>1 &nbsp;&nbsp; *cyl</td>
